...
public class PayrollSystemDemo {
    public static void main(String[] args) {
        ...
        payableList.add(new SalariedEmployee("Josh", "Doe", "111-11-1113", 1000));
        payableList.add(new HourlyEmployee ("Jane", "Smith", "212-11-2121", 40, 15.0));
        payableList.add(new CommissionEmployee("Jim", "Brown", "333-33-3333", 5000.0, 0.05));
        payableList.add(new BasePlusCommissionEmployee("Jill", "White", "444-44-4444", 4000, 0.04, 300.0));
        ...
        if(payable instanceof Employee){
            ...
            System.err.printf("Bonus for Employee: $%.2f%n",emp.calculateBonus(1000));
            System.err.printf("Bonus for Employee: $%.2f%n",emp.calculateBonus(1000, 3));
        }
    }
    }
}