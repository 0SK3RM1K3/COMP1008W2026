...
class Student {
    ...
    void checkProgram() {
        ...
        if(program.equalsIgnoreCase("Computer Science")){
            if(gpa >= 3.5){
                ...
                System.out.println(name + " is not eligible for CS scholoarship");
            }
        }
    }
    ...
    //8.1 Enhance For loop:used to loop through arrays and objects easily
...
//for(dataType variable : arrayName){
    ...
    void updateGPA() {
        ...
        gpa += 0.5;
         System.out.println("Updated GPA after compound addition assignment" + gpa);
        gpa--;
