...
public class StringAndRegexLab {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Are they Equal? " + message.equals(another));
        ...
        // Example: "Java123"
        String replacedExample = "Jave123";
        // Replace all digits with "*"
        String replaced = replacedExample.replaceAll("\\d", "*");
