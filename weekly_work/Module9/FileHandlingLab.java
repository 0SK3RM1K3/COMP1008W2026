...
public class FileHandlingLab {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            Files.write(Paths.get(textFile), "Students List\n".getBytes());
            ...
            Files.write(Paths.get(textFile), "102: Tony - Python\n".getBytes(), StandardOpenOption.APPEND);
            ...
            System.out.println("JSON file creater: " + jsonFile);
            ...
            List loasdedStudents = mapper.readValue(new File(jsonFile), List.class);
 
            // TODO 13:
            // Print the loaded students
            System.out.println("\nLoaded students from JSON: " + loasdedStudents);
